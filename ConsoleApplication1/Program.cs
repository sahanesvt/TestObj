...
namespace TestObjectClass2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Beam Plastic Neutral Axis is {0} in", Math.Round(beam.NA_Plastic(true, false), 4));
            Console.WriteLine("Beam Plastic Moment is {0} kip-ft", Math.Round(beam.Mp(true, false), 4));
